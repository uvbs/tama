...
SE.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CSEApp 응용 프로그램
    클래스를 선언합니다.

SE.cpp
    응용 프로그램 클래스 CSEApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\Toolbar.bmp
    ...
    SE.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 하나의 문서 형식과 하나의 뷰가 만들어집니다.

SEDoc.h, SEDoc.cpp - 문서
    이 파일에는 CSEDoc 클래스가 들어 있습니다.  이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CSEDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

SEView.h, SEView.cpp - 문서 뷰
    이 파일에는 CSEView 클래스가 들어 있습니다.
    CSEView 개체는 CSEDoc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 SE.pch와
