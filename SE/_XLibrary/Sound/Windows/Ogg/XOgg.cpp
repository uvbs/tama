...
void XOgg::Init()
{
	...
	fn_ov_clear = nullptr;
	fn_ov_read = nullptr;
	fn_ov_pcm_total = nullptr;
	fn_ov_info = nullptr;
	fn_ov_comment = nullptr;
	fn_ov_open_callbacks = nullptr;
...
//		ShutdownVorbisFile();
	...
	if (fn_ov_open_callbacks(pOggVorbisFile, &sOggVorbisFile, nullptr, 0, sCallbacks) == 0)
	{
