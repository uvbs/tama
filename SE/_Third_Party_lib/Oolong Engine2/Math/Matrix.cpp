...
void MatrixMakeOrtho( MATRIX &mOut, float left, float right,
                                        ...
                                        float nearZ, float farZ)
{
    ...
    MATRIX m = { 2.0f / rsl, 0.0f, 0.0f, 0.0f,
...
QUATERNION* QuaternionRotationMatrix(QUATERNION &pout, const MATRIX &pm)
{
    ...
    trace = pm.f[0] + pm.f[5] + pm.f[10] + 1.0f;
    if ( trace > 0.0f)
	{
		 pout.x = ( pm.f[6] - pm.f[9] ) / ( 2.0f * sqrt(trace) );
		 pout.y = ( pm.f[8] - pm.f[2] ) / ( 2.0f * sqrt(trace) );
		 pout.z = ( pm.f[1] - pm.f[4] ) / ( 2.0f * sqrt(trace) );
    ...
    {
	 case 0:
	   S = 2.0f * sqrt(1.0f + pm.f[0] - pm.f[5] - pm.f[10]);
	   pout.x = 0.25f * S;
	   pout.y = ( pm.f[1] + pm.f[4] ) / S;
	   pout.z = ( pm.f[2] + pm.f[8] ) / S;
	   pout.w = ( pm.f[6] - pm.f[9] ) / S;
	 break;
	 case 1:
	   S = 2.0f * sqrt(1.0f + pm.f[5] - pm.f[0] - pm.f[10]);
	   pout.x = ( pm.f[1] + pm.f[4] ) / S;
	   pout.y = 0.25f * S;
	   pout.z = ( pm.f[6] + pm.f[9] ) / S;
	   pout.w = ( pm.f[8] - pm.f[2] ) / S;
	 break;
	 case 2:
	   S = 2.0f * sqrt(1.0f + pm.f[10] - pm.f[0] - pm.f[5]);
	   pout.x = ( pm.f[2] + pm.f[8] ) / S;
	   pout.y = ( pm.f[6] + pm.f[9] ) / S;
	   pout.z = 0.25f * S;
	   pout.w = ( pm.f[1] - pm.f[4] ) / S;
	 break;
	}
    return &pout;
}
