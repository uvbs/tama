...
// 			SetNum( reward.num );
// 		if( XE::IsHave(szImg) )
// 			m_pItemImg = IMAGE_MNG->LoadByBatch( XE::MakePath( DIR_ICON, szImg) );
// 	} break;
// 	case xtReward::xRW_CASH: {
// 		m_pItemImg = IMAGE_MNG->LoadByBatch( PATH_UI("shop_cash1.png") );
// 	} break;
...
// 		m_pItemImg = IMAGE_MNG->LoadByBatch( PATH_UI( "guild_coin.png" ) );
// 	} break;
// 	}
...
// 			SAFE_RELEASE2( IMAGE_MNG, m_pItemImg );
// 			m_pItemImg = IMAGE_MNG->LoadByBatch( resFace,
// 																		XE::xPF_ARGB8888,
// 																		true,
// 																		false, false,
// 																		true ); // async
...
// 		for( int i = 0; i < numStar; ++i )
// 			m_aryStar.Add( IMAGE_MNG->LoadByBatch( PATH_UI( "common_etc_smallstar.png" ) ) );
// 		SetbUpdate( true );
// 	}
// }
// 
...
// 		m_Reward.num = 0;
// 	m_psfcBgGradation = IMAGE_MNG->LoadByBatch( PATH_UI( "bg_hero.png" ), XE::xPF_ARGB8888 );
// 	m_pBG = IMAGE_MNG->LoadByBatch( PATH_UI( "common_bg_frame.png" ), XE::xPF_ARGB1555 );
// 	SetSizeLocal( m_pBG->GetWidth(), m_pBG->GetHeight() );
// 	// 아이템일경우 별등급표시
// 	if( m_Reward.GetidItem() ) {
// 		XBREAK( m_pProp == nullptr );
// 		if( m_pProp->IsSoul() ) {
// 			m_pSoulStone = IMAGE_MNG->LoadByBatch( PATH_UI( "frame_soul.png" ), XE::xPF_ARGB1555 );
// 		} else {
// 			// 영혼석이 아닌경우에만 별 그림
...
// 				m_aryStar.Add( IMAGE_MNG->LoadByBatch( PATH_UI( "common_etc_smallstar.png" ) ) );
// 		}
// 		m_pItemImg = IMAGE_MNG->LoadByBatch( XE::MakePath( DIR_IMG, m_pProp->strIcon.c_str() ), XE::xPF_ARGB1555 );
// 	}
// 	return TRUE;
// }
// 
...
// 			m_psfcSelected = IMAGE_MNG->LoadByBatch( PATH_UI( "common_bg_item_glow.png" ), XE::xPF_ARGB8888, true, false, false, true );
// 	}
...
// 		{
// 			XE::xRenderParam param;
// 			param.m_vPos = vPos.x - 3.f, vPos.y - 3.f;
// 			param.m_vScale = vScale;
