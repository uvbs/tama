...
//		xLT_FACEBOOK,		// 페이스북으로 로그인(페북으로 계정을 만들어도 접속은 UUID로 하는걸로 바뀜)
	};
...
public:
	...
	GET_SET_ACCESSOR_CONST( const _tstring&, strFbUsername );
	GET_SET_ACCESSOR_CONST( const _tstring&, strFbName );
