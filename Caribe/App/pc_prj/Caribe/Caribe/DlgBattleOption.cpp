...
void CDlgBattleOption::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check( pDX, IDC_CHECK_NO_DRAW_FACES, m_bNoDraw[4] );
	DDX_Check( pDX, IDC_CHECK_NO_DRAW_FTGL, m_bNoDraw[5] );
	DDX_Check( pDX, IDC_CHECK_NO_DRAW_HPBAR, m_bNoDraw[6] );
	DDX_Check( pDX, IDC_CHECK_NO_DRAW_NAME, m_bNoDraw[7] );
	//
	DDX_Check( pDX, IDC_CHECK_DPCALL, m_bOption[0] );
	DDX_Check( pDX, IDC_CHECK_HERO_INFO_TO_CONSOLE, m_bOption[1] );
	DDX_Check( pDX, IDC_CHECK_FLUSH_IMG, m_bOption[2] );
	DDX_Check( pDX, IDC_CHECK_FLUSH_SPR, m_bOption[3] );
	DDX_Check( pDX, IDC_CHECK_NO_CREATE_DMG_NUM2, m_bOption[16] );
	DDX_Check( pDX, IDC_CHECK_NO_CREATE_HIT_SFX2, m_bOption[17] );
	DDX_Check( pDX, IDC_CHECK_NO_CREATE_SKILL_SFX2, m_bOption[18] );
	DDX_Check( pDX, IDC_CHECK_NO_CREATE_BUFF_ICON2, m_bOption[19] );
	DDX_Check( pDX, IDC_CHECK_STOP_AI, m_bOption[20] );
...
// 	DDX_Check( pDX, IDC_CHECK_NO_DRAW_FACES, m_bNoDraw[4] );
// 	DDX_Check( pDX, IDC_CHECK_NO_DRAW_FTGL, m_bNoDraw[5] );
// 	DDX_Check( pDX, ID_HIDE_HPBAR, m_bNoDraw[6] );
// 	DDX_Check( pDX, ID_HIDE_NAME, m_bNoDraw[7] );
