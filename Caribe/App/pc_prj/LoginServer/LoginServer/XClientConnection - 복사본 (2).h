...
// 	GET_ACCESSOR( XSPLock&, spLock );
	...
	//CallBack
//	void cbCreateNewAccount( XDatabase *pDB, XDBUAccount *pAccOut, const _tstring& strUUID, const _tstring strName, const _tstring strDeviceID, const _tstring strAppstore, ID idKey );
