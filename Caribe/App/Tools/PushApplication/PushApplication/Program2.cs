...
{    
    class Program
    {
        private const string DEVICE_ID = "APA91bFWxsvV3sZjMFQSGj7A500qFWjr8TN0szHh_McV9cDuRgltJfJLs3azOgTDZR-Yqepm9L2MUzNvPYjhQaQq8s-HgrjXM0-QQM2o263ipoVq6_Irk0w6P6u15q7oKAJLU8wospyU";
//        private string strUri = "https://android.googleapis.com/gcm/send";            //google url
        private string strUri = "https://gcm-http.googleapis.com/gcm/send";            //google url
...
//        private string API_KEY = "AIzaSyDGo3mEIx6ykmWSr0AFZzwkvYvZBywW8QA"; //caribe
        ...
        private string GetDeviceList(UInt32 idaccount )
        {
            try
            {
                foreach (KeyValuePair<Int64, DeviceInfo> each in this.DicDeviceID)
                {
                    if (idaccount == each.Value.IdAccount) return each.Value.deviceid;
                }
