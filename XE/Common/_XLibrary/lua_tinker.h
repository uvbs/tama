...
//#include <iostream>
#include <string.h>
//#define _LUA_TINKER_DEBUG
#ifdef _LUA_TINKER_DEBUG
#if defined(_XGAME) || defined(_SE)
	#if defined(_SE)
		#include "ConsoLE2View.h"
	#else
		#include "XDlgConsole.h"
	#endif
#else
	#define CCONSOLE(F,...)	( printf( (F), ##__VA_ARGS__) )
#endif
void PrintStack(lua_State *L) ;
#else
#define PrintStack(A)		(0)
#endif
...
namespace lua_tinker
{
	...
	{ 
		...
		{ 
			...
			{
				lua_pushstring(L, "no class at first argument. (forgot ':' expression ?  or wrong argument type");
				lua_error(L);
			}
	...
	// functor (non-managed)
	template<typename T1, typename T2>
	struct functor<int, lua_State*, T1, T2>
	{
		static int invoke(lua_State *L) { return upvalue_<int(*)(lua_State*,T1,T2)>(L)(L,read<T1>(L,1), read<T2>(L,2)); }
	};
...
*/
	...
	template<typename T, typename T1, typename T2> 
	struct mem_functor<int,T,lua_State*,T1,T2>
	{
		static int invoke(lua_State *L) { return (read<T*>(L,1)->*upvalue_<int(T::*)(lua_State*,T1,T2)>(L))(L, read<T1>(L,2), read<T2>(L,3)); }
	};
	template<typename T, typename T1, typename T2, typename T3> 
	struct mem_functor<int,T,lua_State*,T1,T2,T3>
	{
		static int invoke(lua_State *L) { return (read<T*>(L,1)->*upvalue_<int(T::*)(lua_State*,T1,T2,T3)>(L))(L, read<T1>(L,2), read<T2>(L,3), read<T3>(L,4)); }
	};
	...
	template<typename RVal>
	RVal member_call(lua_State* L, const char* tn, const char* fn )
	{
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
		...
		if(lua_isfunction(L,-1))
		{
			lua_getfield( L, LUA_GLOBALSINDEX, tn );
			lua_pcall(L, 1, 1, errfunc);
		}
		else
		{
	...
	template<typename RVal, typename T1>
	RVal member_call(lua_State* L, const char* tn, const char* fn, T1 arg)
	{
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	// member call
	bool member_isfunction( lua_State* L, const char* tn, const char* fn );

	template<typename RVal, typename T1, typename T2, typename T3>
	RVal member_call(lua_State* L, const char* tn, const char* fn, T1 arg1, T2 arg2, T3 arg3 )
	{
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2, typename T3, typename T4>
	RVal member_call(lua_State* L, const char* tn, const char* fn, T1 arg1, T2 arg2, T3 arg3, T4 arg4 )
	{
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2, typename T3, typename T4, typename T5>
	RVal member_call(lua_State* L, const char* tn, const char* fn, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5 )
	{
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
	RVal member_call(lua_State* L, const char* tn, const char* fn, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6 )
	{
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
	RVal member_call(lua_State* L, const char* tn, const char* fn, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7 )
	{
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	void class_inh(lua_State* L)
	{
		...
		if(lua_istable(L, -1))
		{
			lua_pushstring(L, "__parent1");
		PrintStack(L);
			push_meta(L, class_name<P1>::name());
		PrintStack(L);
			lua_rawset(L, -3);
		PrintStack(L);
			lua_pushstring(L, "__parent2");
		PrintStack(L);
			push_meta(L, class_name<P2>::name());
		PrintStack(L);
			lua_rawset(L, -3);
		PrintStack(L);
		}
