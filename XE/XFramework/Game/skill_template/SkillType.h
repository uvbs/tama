...
typedef list<XBuffObj *>				XBuffObj_List;
typedef list<XBuffObj *>::iterator	XBuffObj_Itor;

typedef list<XSkillReceiver *>				XSkillReceiver_List;
typedef list<XSkillReceiver *>::iterator	XSkillReceiver_Itor;

typedef list<XSkillUser *>				XSkillUser_List;
typedef list<XSkillUser *>::iterator	XSkillUser_Itor;
