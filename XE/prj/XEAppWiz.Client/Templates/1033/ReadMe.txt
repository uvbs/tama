...
응용 프로그램 마법사에서 이 [!output PROJECT_NAME] 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 [!output PROJECT_NAME] 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
[!output PROJECT_NAME].h
    ...
    헤더(Resource.h 포함)가 들어 있고 [!output PROJECT_NAME]App 응용 프로그램
    클래스를 선언합니다.

[!output PROJECT_NAME].cpp
    응용 프로그램 클래스 [!output PROJECT_NAME]App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\[!output PROJECT_NAME].ico
    ...
    주 리소스 파일인 [!output PROJECT_NAME].rc에 의해 포함됩니다.
...
res\Toolbar.bmp
 ...
 리소스 편집기를 사용하여 이 도구 모음 비트맵을 편집하고
    [!output PROJECT_NAME].rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 하나의 문서 형식과 하나의 뷰가 만들어집니다.

[!output PROJECT_NAME]Doc.h, [!output PROJECT_NAME]Doc.cpp - 문서
    이 파일에는 [!output PROJECT_NAME]Doc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 [!output PROJECT_NAME]Doc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

[!output PROJECT_NAME]View.h, [!output PROJECT_NAME]View.cpp - 문서 뷰
    이 파일에는 [!output PROJECT_NAME]View 클래스가 들어 있습니다.
    [!output PROJECT_NAME]View 개체는 [!output PROJECT_NAME]Doc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 [!output PROJECT_NAME].pch와
