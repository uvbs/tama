...
// [!output PROJECT_NAME]Doc.cpp : C[!output PROJECT_NAME]Doc 클래스의 구현
//
...
// 축소판 그림을 지원합니다.
void C[!output PROJECT_NAME]Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void C[!output PROJECT_NAME]Doc::InitializeSearchContent()
{
...
void C[!output PROJECT_NAME]Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
