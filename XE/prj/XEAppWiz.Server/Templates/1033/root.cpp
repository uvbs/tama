...
// [!output PROJECT_NAME].cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
// 유일한 C[!output PROJECT_NAME]App 개체입니다.

C[!output PROJECT_NAME]App theApp;


// C[!output PROJECT_NAME]App 초기화

BOOL C[!output PROJECT_NAME]App::InitInstance()
{
	XEServerApp::InitInstance( this );
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(C[!output PROJECT_NAME]Doc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(C[!output PROJECT_NAME]View));
	if (!pDocTemplate)
		return FALSE;
...
// C[!output PROJECT_NAME]App 메시지 처리기
...
// C[!output PROJECT_NAME]App 메시지 처리기
BOOL C[!output PROJECT_NAME]App::OnIdle(LONG lCount)
{
